* **프로젝트 I (시스템 정의서)**: [project_system_definition.md](./doc/project_system_definition.md)
* **프로젝트 II (대상 시스템 품질 요소 추정)**: [doc/project_quality_elements.txt](./doc/project_quality_elements.txt)

## 4주차 과제 (시스템 품질 요소 추정하기)
* **프로젝트 II (대상 시스템 품질 요소 추정)**:(./doc/project_quality_elements.txt)doc/project_quality_elements.md
* **코멘트 반영 내용**:  
